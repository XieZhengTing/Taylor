...
! Define maximum sizes to avoid large dynamic allocations on the device
INTEGER, PARAMETER :: MAX_MSIZE = 10
INTEGER, PARAMETER :: MAX_NEIGHBORS = 500
...
SUBROUTINE RK1(X, DEG, MSIZE, CONT, IMPL, GCOO, GWIN, GNUMP, LSTACK, LN, LNMAX, EBCS,SELF_EBC, &
    ...
    !LOCAL
    DOUBLE PRECISION:: MINV(MAX_MSIZE,MAX_MSIZE)
    DOUBLE PRECISION:: H(MAX_MSIZE,1)
    DOUBLE PRECISION:: M_FULL(MAX_MSIZE,MAX_MSIZE)
    DOUBLE PRECISION:: M_FULL_STAR(MAX_MSIZE,MAX_MSIZE)
    DOUBLE PRECISION:: B(1,MAX_MSIZE),H0(1,MAX_MSIZE),C(1,1)
    DOUBLE PRECISION:: BX(1,MAX_MSIZE),H0X(1,MAX_MSIZE),CX(1,1)
    DOUBLE PRECISION:: BY(1,MAX_MSIZE),H0Y(1,MAX_MSIZE),CY(1,1)
    DOUBLE PRECISION:: BZ(1,MAX_MSIZE),H0Z(1,MAX_MSIZE),CZ(1,1)

    DOUBLE PRECISION:: H_FULL(MAX_MSIZE,1)
    DOUBLE PRECISION:: H_FULL_STAR(MAX_MSIZE,1)
    DOUBLE PRECISION:: H_FULL_TEMP(MAX_MSIZE,1)
    DOUBLE PRECISION:: C_STAR(1,1),WINDOW_MOD

    ! FOR DIRECT GRADIENT KC
    DOUBLE PRECISION:: H_X(MAX_MSIZE,1),H_Y(MAX_MSIZE,1),H_Z(MAX_MSIZE,1)
    DOUBLE PRECISION:: M_X(MAX_MSIZE,MAX_MSIZE),M_Y(MAX_MSIZE,MAX_MSIZE),M_Z(MAX_MSIZE,MAX_MSIZE)
    DOUBLE PRECISION:: MINV_X(MAX_MSIZE,MAX_MSIZE),MINV_Y(MAX_MSIZE,MAX_MSIZE),MINV_Z(MAX_MSIZE,MAX_MSIZE)
    DOUBLE PRECISION:: MINV_X1(MAX_MSIZE,MAX_MSIZE),MINV_Y1(MAX_MSIZE,MAX_MSIZE),MINV_Z1(MAX_MSIZE,MAX_MSIZE)
    DOUBLE PRECISION:: PHI_X(MAX_NEIGHBORS), PHI_Y(MAX_NEIGHBORS), PHI_Z(MAX_NEIGHBORS), PHIX_X, PHIY_Y, PHIZ_Z
    ...
    DOUBLE PRECISION:: PHI(MAX_NEIGHBORS)
    DOUBLE PRECISION:: XMXI_OA(MAX_NEIGHBORS)
    DOUBLE PRECISION:: YMYI_OA(MAX_NEIGHBORS)
    DOUBLE PRECISION:: ZMZI_OA(MAX_NEIGHBORS)
    DOUBLE PRECISION:: DIA(MAX_NEIGHBORS)
