    ...
    !$ACC PARALLEL LOOP PRESENT(FINT)
    DO I = 1, GNUMP*3
        FINT(I) = 0.0d0
    END DO
    ...
    !$ACC ENTER DATA CREATE(FINT_TEMP)
    !$ACC PARALLEL LOOP COLLAPSE(3) PRESENT(FINT_TEMP)
    DO I = 1, NCORES_INPUT
        DO J = 1, 3
            DO K = 1, GNUMP
                FINT_TEMP(I,J,K) = 0.0D0
            END DO
        END DO
    END DO
    !$ACC END PARALLEL LOOP
    ...
    !$ACC ENTER DATA CREATE(FEXT_TEMP)
    !$ACC PARALLEL LOOP COLLAPSE(3) PRESENT(FEXT_TEMP)
    DO I = 1, NCORES_INPUT
        DO J = 1, 3
            DO K = 1, GNUMP
                FEXT_TEMP(I,J,K) = 0.0D0
            END DO
        END DO
    END DO
    !$ACC END PARALLEL LOOP
    ...
    !$ACC ENTER DATA CREATE(GINT_WORK_TEMP)
    !$ACC PARALLEL LOOP PRESENT(GINT_WORK_TEMP)
    DO I = 1, NCORES_INPUT
        GINT_WORK_TEMP(I) = 0.0d0
    END DO
    !$ACC END PARALLEL LOOP
