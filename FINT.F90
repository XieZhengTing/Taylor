    ...
    DOUBLE PRECISION :: LDINC(3,GMAXN), LDINC_TOT(3,GMAXN)       ! DISPLACEMENT INCREMENT (PREDICTOR) OF A NODE    DOUBLE PRECISION:: LCOO_CUURENT(3,GMAXN)  !CURRENT COORDINATES OF THE NEIGBORS
