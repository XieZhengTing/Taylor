      ...
      !INTEGER:: IGRAVITY
	  write(*,*) 'Alterady in Pre_Control.F90'
...
120       CONTINUE
    ...
    write(*,*) 'OUTPUT VARIABLES has been read !'
	  ...
	  DO 
        ...
        IF (IPERIDYNAMICS.EQ.1) THEN
              PERIDYNAMICS =  .TRUE.
        ENDIF
        write(*,*) 'IPERIDYNAMICS = ', IPERIDYNAMICS
      ENDIF
        ...
        write(*,*) 'RK_DEGREE, RK_CONT, RK_IMPL = ', RK_DEGREE, RK_CONT, RK_IMPL
      ...
      IF (.NOT.READ_INTEGRATION_PARAMETERS) THEN
        ...
        ITYPE_INT = 0
        !SERIAL
        CALL LOG_APPEND('ITYPE_INT = 0 (DNI)')
        
        WRITE(*,*) ' '
        WRITE(*,*) 'ITYPE_INT = 0 (DNI)'
        WRITE(*,*) ' '
      END IF
