...
MODULE CONSTITUTE_DRUCKPRAG_MOD
  USE FINT_FUNCTIONS ! 以及 DRUCK_PRAG 可能需要的其他模組
  IMPLICIT NONE
  PRIVATE
  PUBLIC :: DRUCK_PRAG
...
CONTAINS	  
      ...
      SUBROUTINE DRUCK_PRAG(STRESS, TOTAL_STRAIN, INC_STRAIN, STRESS_PREDICT, STATE, PROPS, ierr)
	  !$ACC ROUTINE SEQ
	  ...
	  RETURN
	  END SUBROUTINE
END MODULE CONSTITUTE_DRUCKPRAG_MOD		